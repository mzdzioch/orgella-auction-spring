...
public class AuctionServiceTest {
    ...
    @Test
    public void shouldReturnTrueIfGetOneInactiveAuction() throws Exception {
        List<Auction> auctions = new ArrayList<>();
    ...
    public void shouldReturnTrueIfBidIsHigherThan() throws Exception {
        ...
        Auction auction = auctionService.getAuction(21);

        List<Auction> list = auctionService.getAllActiveAuctions();
        for (Auction auction2 : list) {
            System.out.println(auction2.getId());
        }
    ...
    @Test
    public void shouldReturnTrueIfListBidsIsEmpty() throws Exception {
    ...
    @Test
    public void shouldReturnTrueIfListBidsEmpty() throws Exception {
